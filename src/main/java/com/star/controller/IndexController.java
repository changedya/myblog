...
//    博客信息
    ...
    public String blogMessage(Model model){
        ...
        model.addAttribute("blogTotal",blogTotal!=null?blogTotal:0);
        model.addAttribute("blogViewTotal",blogViewTotal!=null?blogViewTotal:0);
        model.addAttribute("blogCommentTotal",blogCommentTotal!=null?blogCommentTotal:0);
        model.addAttribute("blogMessageTotal",blogMessageTotal!=null?blogMessageTotal:0);
